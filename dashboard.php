...
<html lang="en">
    <head>
        ...
        <title>AQ_CODE BASE MULTI PURPOSE EXAMINATION SYSTEM FOR AAMUSTED | Dashboard</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h3 class="title">AQ_CODE BASE MULTI PURPOSE EXAMINATION SYSTEM Dashboard</h3>
...
?>
        ...
        <!-- /.main-wrapper -->
        <script>
        // Ensure this script is executed after all other scripts
        document.addEventListener('DOMContentLoaded', function() {
            // Disable Toastr notifications
            ...
            // Disable Noty notifications
            if (typeof Noty !== 'undefined') {
                Noty.prototype.show = function() {};
            }

            // Disable custom notification function
