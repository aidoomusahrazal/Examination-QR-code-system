...
<html lang="en">
    <head>
        ...
        <title>EXAMINATION REGISTRATION AND VERIFICATION USING QR CODE SYSTEM</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">EXAMINATION REGISTRATION AND VERIFICATION USING QR CODE SYSTEM</h2>
                                </div>
                            </div>
                            <!-- /.row -->
