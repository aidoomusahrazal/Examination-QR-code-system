...
if(isset($_POST['delete'])){
    $id_to_delete = intval($_POST['resultid']);
    $sql = "DELETE FROM tblresult WHERE id=:id_to_delete";
    $query = $dbh->prepare($sql);
    $query->bindParam(':id_to_delete', $id_to_delete, PDO::PARAM_INT);
    $query->execute();
                                            ...
                                            if($query->rowCount() > 0)
                                            {
                                                ...
                                                {  ?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-2">
                                                            <form method="post">
                                                                <input type="hidden" name="resultid" value="<?php echo htmlentities($result->resultid); ?>">
