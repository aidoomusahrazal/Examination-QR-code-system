<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <h6 class="title">INFO TECH</h6>
                                <small class="info">Project Work @2023</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Registration | QR code </span> </a>
                                     
                                    </li>

                                    <li class="nav-header">
                                        <span class="">Student Appearance</span>
                                    </li>
  ...
  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Create Courses</span></a></li>
                                            <li><a href="manage-subjects.php"><i class="fa fa fa-server"></i> <span>Manage Courses</span></a></li>
                                           <li><a href="add-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Register Courses</span></a></li>
                                           <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Courses </span></a></li>
                                        </ul>
                                    </li>
   <li class="has-children">
...
<li class="has-children">
                                    ...
                                    <li class="nav-header">
                                        <span class="">QR Code Generation</span>
                                    </li>
                                   
                                        <ul class="child-nav">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>QR code Generation</span> <i class="fa fa-angle-right arrow"></i></a>
                                            <li><a href="fetch-students.php"><i class="fa fa-bars"></i> <span>Add Student Details</span></a></li>
